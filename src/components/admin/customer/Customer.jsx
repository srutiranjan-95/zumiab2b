...
function Customer() {
  ...
  const [showVisitingCard, setShowVisitingCard] =
    useState(false);
  ...
  return (
    <div className="relative min-h-screen bg-[#F7F8FA]">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <button className="h-[36px] px-4 rounded-xl bg-white border border-gray-200 shadow-sm flex items-center gap-2 text-[11px] font-medium hover:bg-gray-50 transition-all duration-300">
          ...
          (
            ...
            >
              ...
              <div className="flex items-start justify-between gap-4">
                ...
                {/* RIGHT */}
                <button className="w-7 h-7 rounded-lg flex items-center justify-center hover:bg-gray-100 transition-all duration-300 shrink-0">
